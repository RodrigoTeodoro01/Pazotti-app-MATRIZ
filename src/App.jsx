...
const SUPERVISORES = [
  "JOSE AMOS", "SAMUEL", "ANDRE DUARTE", "DIEGO", "FABIO FIRMINO",
  "EMERSON", "MAICON", "THIAGO", "GERAL"
];

const INDUSTRIES = [
  "AJIN. MID", "AJINOMOTO", "BARION", "BETTANIN", "CAFE PELE", "CAMIL",
  "CAMPOLARGO", "CASA SUICA", "COQUEIRO", "DR.OETKER", "FER.PASCOA", "FERRERO",
  "FINI", "FINI GERAL", "FORNOMINAS", "HERS CAMP", "HERSHEYS", "INGLEZA", "JDE CAFES",
  "JDE CAMP", "KERO-COCO", "LINEA", "LUXCAR", "MABEL", "MAGUARY", "MARILAN",
  "MASSAS CAM", "MAVALERIO", "MCCAIN", "N. ALIANÇA", "NISSIN", "NISSIN CUP",
  "NUTRATA", "PEPSICO", "QUEENSBERY", "SAKURA", "STA HELENA", "STA MARIA",
  "TIAL", "TODESCHINI", "TOP CAU", "VAPZA", "YPE", "YPE CAMP"
];
...
function App() {
  ...
  const [cloudUrl, setCloudUrl] = useState(() => {
    const saved = localStorage.getItem('pazotti_cloud_url_v3');
  ...
  useEffect(() => {
    localStorage.setItem('pazotti_cloud_url_v3', cloudUrl);
  }, [cloudUrl]);
      ...
      <div className="container" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '80vh' }}>
        <div className="glass-card" style={{ maxWidth: '400px', width: '100%' }}>
          <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
            <img src="/pazotti-app-MATRIZ/logo.png" alt="Logo Pazotti Matriz" style={{ height: '60px', objectFit: 'contain', marginBottom: '1rem' }} />
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem', flexWrap: 'wrap', gap: '1rem' }}>
        <div>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <img src="/pazotti-app-MATRIZ/logo.png" alt="Logo Pazotti Matriz" style={{ height: '40px', objectFit: 'contain' }} />
