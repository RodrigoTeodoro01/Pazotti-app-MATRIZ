...
const SUPERVISORES = [
  "ANDRE DUARTE", "DANIELA MARTINS", "EMERSON", "FABIO FIRMINO", "JOSE AMOS", "MAICON", "SAMUEL", "THIAGO", "GERAL"
];

const INDUSTRIES = [
  "MOCOCA SA", "AJIN. MID", "AJINO.FOOD", "AJINOMOTO", "AVANT", "BARION", "BEAUTYCOLO",
